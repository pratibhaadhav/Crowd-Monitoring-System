...
heading = tk.Label(root,text=" Crowd Monitoring System",width=45,height=1,font=("Times New Roman",45,'bold'),bg="#192841",fg="white")
...
def show_FDD_video(video_path):
    ...
    FALLModel=load_model('E:/Crowd_Monitoring/abnormalevent.h5')    #video = cv.VideoCapture(video_path);
    ...
    while True:
        ...
        if  label == 1 :
            label_text = "Crowd Detected"
            color = red
        else:
            label_text = "Normal Crowd detected"
            color = green
...
button5 = tk.Button(root,command = Video_Verify, text=" Crowd Monitoring  Detection", width=25,font=("Times new roman", 25, "bold"),bg="cyan",fg="black")
