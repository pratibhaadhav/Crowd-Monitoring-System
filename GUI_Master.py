...
img=ImageTk.PhotoImage(Image.open("s11.jpg"))

img2=ImageTk.PhotoImage(Image.open("s22.jpg"))

img3=ImageTk.PhotoImage(Image.open("s33.jpg"))
...
heading = tk.Label(root,text="Suspicious Activity Detection",width=45,height=1,font=("Times New Roman",45,'bold'),bg="#192841",fg="white")
