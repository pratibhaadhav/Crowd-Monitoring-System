...
bg_icon=ImageTk.PhotoImage(file="E:/Alzheimer_Disease/L.jpg")
user_icon=ImageTk.PhotoImage(file="E:/Alzheimer_Disease/l1.png")
pass_icon=ImageTk.PhotoImage(file="E:/Alzheimer_Disease/p1.jpg")
